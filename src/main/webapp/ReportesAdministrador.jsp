...
<%if(tipoReporte.equals("1")||tipoReporte.equals("5") || tipoReporte.equals("6") || tipoReporte.equals("7")){%>

<form action="ReportesAdministrador.jsp">
    <%if(tipoReporte.equals("1")|| tipoReporte.equals("6")){%>
Ingrese el codigo del usuario <input type="text" name="Codigousuario" >
    <%}%>
...
<table class="table table-success table-striped" id="tabla_libros">
    ...
    <tr>
        ...
        <th>Codigo Usuairo Modificado</th>
    ...
    <tr>
        ...
        <td><%= cambio.getCodigoGerente() %>
        </td>
        <td><%= cambio.getCodigoUsuarioModificafo()%>
        </td>
        <td><%=cambio.getNombreUsuarioModificado()%></td>
        <td><%= cambio.getFecha() +"  "+ cambio.getHora() %>
